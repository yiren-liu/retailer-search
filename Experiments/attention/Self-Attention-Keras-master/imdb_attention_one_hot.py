...
[x_train, x_test],[y_train, y_test] = get_search_data_one_hot()
...
S_inputs = Input(shape=(x_train.shape[1],))
embeddings = Embedding(20000, 128)(S_inputs)
