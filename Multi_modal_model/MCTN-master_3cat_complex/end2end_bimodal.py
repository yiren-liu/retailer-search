...
# =======
# sys.path.extend(['/home/yirenl2/retailer-search/Multi_modal_model/MCTN-master_3cat_simple/models/']):Multi_modal_model/MCTN-master_3cat_simple/end2end_bimodal.py
import numpy as np
