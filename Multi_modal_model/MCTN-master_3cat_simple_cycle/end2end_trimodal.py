...
print("PREDICTING...")
encoded_representation=end2end_model.encoded_representation.predict(end2end_model.test_first)
a=end2end_model.encoded_representation.predict(end2end_model.train_first)
b=end2end_model.encoded_representation.predict(end2end_model.test_first)
