...
def create_regression_model(n_hidden, input, l2_factor,input_hidden,dropout):
  """
  ...
  activations = LSTM(n_hidden,
                     name='lstm_layer',
                     trainable=True,dropout=dropout,recurrent_dropout=dropout,
  ...
  # x=Bidirectional(LSTM(n_hidden,dropout=dropout,recurrent_dropout=dropout))(input)
  # # x=Dropout(dropout)(x)
  #
  #
  # def slice(x, index):
  ...
  #     return x[:,index, :]
  #
  # # x = Lambda(slice,  arguments={'index': -1})(input)
  # # x=Reshape((-1,input_hidden))(x)
  #
  #
  #
  # x=Dense(100)(x)#input[:,-1,:]
  # x=Dropout(dropout)(x)
